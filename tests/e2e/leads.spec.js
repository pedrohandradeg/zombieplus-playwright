...
test('Não deve cadastrar com email incorreto', async ({ page }) => {
  ...
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('Tester123', 'testeemail.com.br')
...
test('Não deve cadastrar com campo nome vazio', async ({ page }) => {
  ...
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('', 'teste@email.com')
...
test('Não deve cadastrar com campo email vazio', async ({ page }) => {
  ...
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('Tester123', '')
